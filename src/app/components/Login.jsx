...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post("http://localhost:3001/api/v1/public/clients/login", { email, password })
            alert(data.message)
            router.push('/')
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                ¿Aún no tienes cuenta? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                            </p>
                        </form>
                    </div>
                </div>
